<template>
  <div v-if="deferredPrompt"
    class="fixed bottom-5 right-5 bg-white shadow-lg rounded-xl p-4 flex items-center space-x-3">
    ...
    <button @click="closePrompt" class="text-gray-500 hover:text-gray-700">✖</button>
  </div>
</template>
